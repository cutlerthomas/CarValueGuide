...
features = ['Year', 'Engine Fuel Type', 'Engine HP', 'Engine Cylinders',
            ...
            'Vehicle Size', 'Vehicle Style', 'highway MPG', 'city mpg', 'Popularity', 'cluster', 'P1', 'P2']
target = 'P3'
...
dump(pipeline, 'vehicle_p3_model.joblib')
print("Cross Validation R2 Scores(P3):", cv_scores)
print("Mean CV R2 Score(P3):", cv_scores.mean())